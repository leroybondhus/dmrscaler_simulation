...
load("ttest_method_set_list.Rdata")
load("ttest_simul_constructor_list.Rdata")
...
if(file.exists("GLOBAL_OPERATING_STATS.Rdata")){
  ...
  save(GLOBAL_OPERATING_STATS, file="ttest_GLOBAL_OPERATING_STATS.Rdata")
}
