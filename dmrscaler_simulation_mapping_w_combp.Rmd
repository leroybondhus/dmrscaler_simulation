...
filename<-paste(results_dir, date, "_",  "mapping_ratios_vert.tiff", sep = "")
#tiff(filename = filename, width = 8, height=4, units = "in", res = 500, pointsize = 1)
...
filename<-paste(results_dir, date, "_",  "methods_time.png", sep = "")

ggsave(
  filename=filename, plot = gg, device = "png", path = NULL, scale = 1,
  width = 3, height = 3, units = c("in"), dpi = 320
)
