...
for(i in 1:length(simul_results)){
  ...
  OPERATING_STATS$cpg_probe[i,]$P <- -1 
  OPERATING_STATS$cpg_probe[i,]$N <- -1
  OPERATING_STATS$cpg_probe[i,]$TP_called <- -1
  OPERATING_STATS$cpg_probe[i,]$TP_simul <- -1
  OPERATING_STATS$cpg_probe[i,]$TN <- -1
