...
# RGSet <- read.metharray.exp(base = idats_files)
...
for(RUN in 1:3){
        ...
        temp <- DMRscaler::dmrscaler(locs = locs2, locs_pval_cutoff = 0.05, region_signif_method = "benj", region_signif_cutoff = 0.01, window_type = "k_near", window_sizes = c(2,4,8,16,32,64), output_type = "comp")
