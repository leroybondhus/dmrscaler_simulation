...
temp_colnames <- c("method","delta_beta","noise","rep",
                   ...
                   "TP_called", "TP_simul", "FP", "FN"  ## 1-self: FP,FN, 
                   )
...
for(i in 1:length(simul_results)){
  ...
  OPERATING_STATS$feature$P <- length(simul_grs) 
  OPERATING_STATS$feature$N <- -1
  OPERATING_STATS$feature$TP_called <- -1
  OPERATING_STATS$feature$TP_simul <- -1
  OPERATING_STATS$feature$FP <- -1
  OPERATING_STATS$feature$FN <- -1
  ...
  OPERATING_STATS$basepair$FP <- -1
  OPERATING_STATS$basepair$FN <- -1
